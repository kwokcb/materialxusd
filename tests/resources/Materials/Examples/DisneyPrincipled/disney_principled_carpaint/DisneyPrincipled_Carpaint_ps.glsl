...
uniform vec3 SR_carpaint_baseColor = vec3(0.051890, 0.296060, 0.425324);
uniform float SR_carpaint_metallic = 0.000000;
uniform float SR_carpaint_roughness = 0.400000;
uniform float SR_carpaint_anisotropic = 0.500000;
uniform float SR_carpaint_specular = 0.500000;
uniform float SR_carpaint_specularTint = 0.000000;
uniform float SR_carpaint_sheen = 0.000000;
uniform float SR_carpaint_sheenTint = 0.500000;
uniform float SR_carpaint_clearcoat = 1.000000;
uniform float SR_carpaint_clearcoatGloss = 1.000000;
uniform float SR_carpaint_specTrans = 0.000000;
uniform float SR_carpaint_ior = 1.500000;
uniform float SR_carpaint_subsurface = 0.000000;
uniform vec3 SR_carpaint_subsurfaceDistance = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    material DisneyPrincipled_Carpaint_out = SR_carpaint_out;
    out1 = vec4(DisneyPrincipled_Carpaint_out.color, 1.0);
}
