...
uniform vec3 SR_glass_baseColor = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_glass_metallic = 0.000000;
uniform float SR_glass_roughness = 0.010000;
uniform float SR_glass_anisotropic = 0.000000;
uniform float SR_glass_specular = 0.500000;
uniform float SR_glass_specularTint = 0.000000;
uniform float SR_glass_sheen = 0.000000;
uniform float SR_glass_sheenTint = 0.500000;
uniform float SR_glass_clearcoat = 0.000000;
uniform float SR_glass_clearcoatGloss = 1.000000;
uniform float SR_glass_specTrans = 1.000000;
uniform float SR_glass_ior = 1.520000;
uniform float SR_glass_subsurface = 0.000000;
uniform vec3 SR_glass_subsurfaceDistance = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    NG_disney_principled(SR_glass_baseColor, SR_glass_metallic, SR_glass_roughness, SR_glass_anisotropic, SR_glass_specular, SR_glass_specularTint, SR_glass_sheen, SR_glass_sheenTint, SR_glass_clearcoat, SR_glass_clearcoatGloss, SR_glass_specTrans, SR_glass_ior, SR_glass_subsurface, SR_glass_subsurfaceDistance, SR_glass_out);
    material DisneyPrincipled_Glass_out = SR_glass_out;
    out1 = vec4(DisneyPrincipled_Glass_out.color, 1.0);
}
