...
uniform vec3 SR_gold_baseColor = vec3(0.944000, 0.776000, 0.373000);
uniform float SR_gold_metallic = 1.000000;
uniform float SR_gold_roughness = 0.020000;
uniform float SR_gold_anisotropic = 0.000000;
uniform float SR_gold_specular = 0.500000;
uniform float SR_gold_specularTint = 0.000000;
uniform float SR_gold_sheen = 0.000000;
uniform float SR_gold_sheenTint = 0.500000;
uniform float SR_gold_clearcoat = 0.000000;
uniform float SR_gold_clearcoatGloss = 1.000000;
uniform float SR_gold_specTrans = 0.000000;
uniform float SR_gold_ior = 1.500000;
uniform float SR_gold_subsurface = 0.000000;
uniform vec3 SR_gold_subsurfaceDistance = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    NG_disney_principled(SR_gold_baseColor, SR_gold_metallic, SR_gold_roughness, SR_gold_anisotropic, SR_gold_specular, SR_gold_specularTint, SR_gold_sheen, SR_gold_sheenTint, SR_gold_clearcoat, SR_gold_clearcoatGloss, SR_gold_specTrans, SR_gold_ior, SR_gold_subsurface, SR_gold_subsurfaceDistance, SR_gold_out);
    material DisneyPrincipled_Gold_out = SR_gold_out;
    out1 = vec4(DisneyPrincipled_Gold_out.color, 1.0);
}
