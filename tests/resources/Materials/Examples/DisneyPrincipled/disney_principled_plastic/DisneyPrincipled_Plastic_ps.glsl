...
uniform vec3 SR_plastic_baseColor = vec3(0.104704, 0.241883, 0.818000);
uniform float SR_plastic_metallic = 0.000000;
uniform float SR_plastic_roughness = 0.324675;
uniform float SR_plastic_anisotropic = 0.000000;
uniform float SR_plastic_specular = 0.500000;
uniform float SR_plastic_specularTint = 0.000000;
uniform float SR_plastic_sheen = 0.000000;
uniform float SR_plastic_sheenTint = 0.500000;
uniform float SR_plastic_clearcoat = 0.000000;
uniform float SR_plastic_clearcoatGloss = 1.000000;
uniform float SR_plastic_specTrans = 0.000000;
uniform float SR_plastic_ior = 1.500000;
uniform float SR_plastic_subsurface = 0.000000;
uniform vec3 SR_plastic_subsurfaceDistance = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    material DisneyPrincipled_Plastic_out = SR_plastic_out;
    out1 = vec4(DisneyPrincipled_Plastic_out.color, 1.0);
}
