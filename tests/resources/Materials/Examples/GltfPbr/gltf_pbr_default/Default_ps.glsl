...
uniform vec3 SR_default_base_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_default_metallic = 1.000000;
uniform float SR_default_roughness = 1.000000;
uniform float SR_default_occlusion = 0.000000;
...
uniform float SR_default_alpha = 1.000000;
uniform int SR_default_alpha_mode = 0;
uniform float SR_default_alpha_cutoff = 0.500000;
uniform float SR_default_iridescence = 0.000000;
uniform float SR_default_iridescence_ior = 1.300000;
uniform float SR_default_iridescence_thickness = 300.000000;
uniform vec3 SR_default_sheen_color = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_default_sheen_roughness = 0.000000;
uniform float SR_default_clearcoat = 0.000000;
uniform float SR_default_clearcoat_roughness = 0.000000;
uniform vec3 SR_default_emissive = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_default_emissive_strength = 1.000000;
uniform float SR_default_thickness = 0.000000;
uniform float SR_default_attenuation_distance = 100000.000000;
uniform vec3 SR_default_attenuation_color = vec3(0.000000, 0.000000, 0.000000);
...
void main()
{
    ...
    IMPL_gltf_pbr_surfaceshader(SR_default_base_color, SR_default_metallic, SR_default_roughness, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_default_occlusion, SR_default_transmission, SR_default_specular, SR_default_specular_color, SR_default_ior, SR_default_alpha, SR_default_alpha_mode, SR_default_alpha_cutoff, SR_default_iridescence, SR_default_iridescence_ior, SR_default_iridescence_thickness, SR_default_sheen_color, SR_default_sheen_roughness, SR_default_clearcoat, SR_default_clearcoat_roughness, geomprop_Nworld_out1, SR_default_emissive, SR_default_emissive_strength, SR_default_thickness, SR_default_attenuation_distance, SR_default_attenuation_color, SR_default_out);
    material Default_out = SR_default_out;
    float outAlpha = clamp(1.0 - dot(Default_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(Default_out.color, outAlpha);
