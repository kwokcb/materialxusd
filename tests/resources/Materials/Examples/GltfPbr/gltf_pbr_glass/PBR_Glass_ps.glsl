...
uniform vec3 SR_glass_base_color = vec3(1.000000, 1.000000, 1.000000);
...
uniform float SR_glass_alpha = 1.000000;
uniform int SR_glass_alpha_mode = 0;
uniform float SR_glass_alpha_cutoff = 0.500000;
uniform float SR_glass_iridescence = 0.000000;
uniform float SR_glass_iridescence_ior = 1.300000;
uniform float SR_glass_iridescence_thickness = 100.000000;
uniform vec3 SR_glass_sheen_color = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_glass_sheen_roughness = 0.000000;
uniform float SR_glass_clearcoat = 0.000000;
uniform float SR_glass_clearcoat_roughness = 0.000000;
uniform vec3 SR_glass_emissive = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_glass_emissive_strength = 1.000000;
uniform float SR_glass_thickness = 0.000000;
uniform float SR_glass_attenuation_distance = 0.0;
uniform vec3 SR_glass_attenuation_color = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    IMPL_gltf_pbr_surfaceshader(SR_glass_base_color, SR_glass_metallic, SR_glass_roughness, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_glass_occlusion, SR_glass_transmission, SR_glass_specular, SR_glass_specular_color, SR_glass_ior, SR_glass_alpha, SR_glass_alpha_mode, SR_glass_alpha_cutoff, SR_glass_iridescence, SR_glass_iridescence_ior, SR_glass_iridescence_thickness, SR_glass_sheen_color, SR_glass_sheen_roughness, SR_glass_clearcoat, SR_glass_clearcoat_roughness, geomprop_Nworld_out1, SR_glass_emissive, SR_glass_emissive_strength, SR_glass_thickness, SR_glass_attenuation_distance, SR_glass_attenuation_color, SR_glass_out);
    material PBR_Glass_out = SR_glass_out;
    float outAlpha = clamp(1.0 - dot(PBR_Glass_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(PBR_Glass_out.color, outAlpha);
