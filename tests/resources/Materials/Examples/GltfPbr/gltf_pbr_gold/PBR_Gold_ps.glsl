...
uniform vec3 SR_gold_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_gold_ior = 1.500000;
uniform float SR_gold_alpha = 1.000000;
uniform int SR_gold_alpha_mode = 0;
uniform float SR_gold_alpha_cutoff = 0.500000;
uniform float SR_gold_iridescence = 0.000000;
uniform float SR_gold_iridescence_ior = 1.300000;
uniform float SR_gold_iridescence_thickness = 100.000000;
uniform vec3 SR_gold_sheen_color = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_gold_sheen_roughness = 0.000000;
uniform float SR_gold_clearcoat = 0.000000;
uniform float SR_gold_clearcoat_roughness = 0.000000;
uniform vec3 SR_gold_emissive = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_gold_emissive_strength = 1.000000;
uniform float SR_gold_thickness = 0.000000;
uniform float SR_gold_attenuation_distance = 0.0;
uniform vec3 SR_gold_attenuation_color = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    out1 = vec4(PBR_Gold_out.color, outAlpha);
