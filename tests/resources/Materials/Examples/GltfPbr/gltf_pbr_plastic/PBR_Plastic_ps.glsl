...
uniform float SR_plastic_alpha = 1.000000;
uniform int SR_plastic_alpha_mode = 0;
uniform float SR_plastic_alpha_cutoff = 0.500000;
uniform float SR_plastic_iridescence = 0.000000;
uniform float SR_plastic_iridescence_ior = 1.300000;
uniform float SR_plastic_iridescence_thickness = 100.000000;
uniform vec3 SR_plastic_sheen_color = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_plastic_sheen_roughness = 0.000000;
uniform float SR_plastic_clearcoat = 0.000000;
uniform float SR_plastic_clearcoat_roughness = 0.000000;
uniform vec3 SR_plastic_emissive = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_plastic_emissive_strength = 1.000000;
uniform float SR_plastic_thickness = 0.000000;
uniform float SR_plastic_attenuation_distance = 0.0;
uniform vec3 SR_plastic_attenuation_color = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    IMPL_gltf_pbr_surfaceshader(SR_plastic_base_color, SR_plastic_metallic, SR_plastic_roughness, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_plastic_occlusion, SR_plastic_transmission, SR_plastic_specular, SR_plastic_specular_color, SR_plastic_ior, SR_plastic_alpha, SR_plastic_alpha_mode, SR_plastic_alpha_cutoff, SR_plastic_iridescence, SR_plastic_iridescence_ior, SR_plastic_iridescence_thickness, SR_plastic_sheen_color, SR_plastic_sheen_roughness, SR_plastic_clearcoat, SR_plastic_clearcoat_roughness, geomprop_Nworld_out1, SR_plastic_emissive, SR_plastic_emissive_strength, SR_plastic_thickness, SR_plastic_attenuation_distance, SR_plastic_attenuation_color, SR_plastic_out);
    material PBR_Plastic_out = SR_plastic_out;
    float outAlpha = clamp(1.0 - dot(PBR_Plastic_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(PBR_Plastic_out.color, outAlpha);
