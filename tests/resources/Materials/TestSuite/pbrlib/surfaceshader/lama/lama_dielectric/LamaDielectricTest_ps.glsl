...
uniform float LamaDielectricSurface_opacity = 1.000000;
uniform bool LamaDielectricSurface_thin_walled = false;
...
void main()
{
    ...
    surfaceshader LamaDielectricSurface_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        float surfaceOpacity = LamaDielectricSurface_opacity;
        ...
        // Add environment contribution
        {
            ...
            LamaDielectricSurface_out.color += occlusion * LamaDielectric_out.response;
        }
        ...
        BSDF LamaDielectric_out = BSDF(vec3(0.0),vec3(1.0));
        IMPL_lama_dielectric(closureData, LamaDielectric_reflectionTint_cm_out, LamaDielectric_transmissionTint_cm_out, LamaDielectric_fresnelMode, LamaDielectric_IOR, LamaDielectric_reflectivity, LamaDielectric_roughness, geomprop_Nworld_out1, LamaDielectric_anisotropy, geomprop_Tworld_out1, LamaDielectric_rotation, LamaDielectric_absorptionColor_cm_out, LamaDielectric_absorptionRadius, LamaDielectric_scatterColor_cm_out, LamaDielectric_scatterAnisotropy, LamaDielectric_out);
        LamaDielectricSurface_out.color += LamaDielectric_out.response;

        // Compute and apply surface opacity
        {
            LamaDielectricSurface_out.color *= surfaceOpacity;
            LamaDielectricSurface_out.transparency = mix(vec3(1.0), LamaDielectricSurface_out.transparency, surfaceOpacity);
        }
    }

    material LamaDielectricTest_out = LamaDielectricSurface_out;
    out1 = vec4(LamaDielectricTest_out.color, 1.0);
}
