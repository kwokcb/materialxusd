...
uniform vec3 color_gamma22_value_cm_in = vec3(0.500000, 0.000000, 0.000000);
uniform vec3 ColorSpaceShader_specular_color_cm_in = vec3(0.200000, 0.600000, 0.800000);
uniform float ColorSpaceShader_base = 0.500000;
uniform float ColorSpaceShader_diffuse_roughness = 0.000000;
uniform float ColorSpaceShader_metalness = 0.000000;
uniform float ColorSpaceShader_specular = 1.000000;
uniform float ColorSpaceShader_specular_roughness = 0.200000;
uniform float ColorSpaceShader_specular_IOR = 1.500000;
uniform float ColorSpaceShader_specular_anisotropy = 0.000000;
uniform float ColorSpaceShader_specular_rotation = 0.000000;
uniform float ColorSpaceShader_transmission = 0.000000;
uniform vec3 ColorSpaceShader_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float ColorSpaceShader_transmission_depth = 0.000000;
uniform vec3 ColorSpaceShader_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float ColorSpaceShader_transmission_scatter_anisotropy = 0.000000;
uniform float ColorSpaceShader_transmission_dispersion = 0.000000;
uniform float ColorSpaceShader_transmission_extra_roughness = 0.000000;
uniform float ColorSpaceShader_subsurface = 0.000000;
uniform vec3 ColorSpaceShader_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 ColorSpaceShader_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float ColorSpaceShader_subsurface_scale = 1.000000;
uniform float ColorSpaceShader_subsurface_anisotropy = 0.000000;
uniform float ColorSpaceShader_sheen = 0.000000;
uniform vec3 ColorSpaceShader_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float ColorSpaceShader_sheen_roughness = 0.300000;
uniform float ColorSpaceShader_coat = 0.000000;
uniform vec3 ColorSpaceShader_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float ColorSpaceShader_coat_roughness = 0.100000;
uniform float ColorSpaceShader_coat_anisotropy = 0.000000;
uniform float ColorSpaceShader_coat_rotation = 0.000000;
uniform float ColorSpaceShader_coat_IOR = 1.500000;
uniform float ColorSpaceShader_coat_affect_color = 0.000000;
uniform float ColorSpaceShader_coat_affect_roughness = 0.000000;
uniform float ColorSpaceShader_thin_film_thickness = 0.000000;
uniform float ColorSpaceShader_thin_film_IOR = 1.500000;
uniform float ColorSpaceShader_emission = 0.000000;
uniform vec3 ColorSpaceShader_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 ColorSpaceShader_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool ColorSpaceShader_thin_walled = false;
...
void main()
{
    vec3 color_gamma22_value_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(color_gamma22_value_cm_in, color_gamma22_value_cm_out);
    vec3 ColorSpaceShader_specular_color_cm_out = vec3(0.0);
    ...
    surfaceshader ColorSpaceShader_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material ColorSpaceShaderMaterial_out = ColorSpaceShader_out;
    out1 = vec4(ColorSpaceShaderMaterial_out.color, 1.0);
}
