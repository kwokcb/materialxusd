...
uniform vec3 ramp4_valuetl = vec3(1.000000, 0.000000, 0.000000);
uniform vec3 ramp4_valuetr = vec3(0.100000, 0.000000, 0.000000);
uniform vec3 ramp4_valuebl = vec3(1.000000, 0.000000, 0.000000);
uniform vec3 ramp4_valuebr = vec3(0.100000, 0.000000, 0.000000);
uniform float MappedShader_base = 1.000000;
uniform float MappedShader_diffuse_roughness = 0.000000;
uniform float MappedShader_metalness = 0.333000;
uniform float MappedShader_specular = 0.000000;
uniform float MappedShader_specular_roughness = 0.200000;
uniform float MappedShader_specular_IOR = 1.500000;
uniform float MappedShader_specular_anisotropy = 0.000000;
uniform float MappedShader_specular_rotation = 0.000000;
uniform float MappedShader_transmission = 0.000000;
uniform vec3 MappedShader_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float MappedShader_transmission_depth = 0.000000;
uniform vec3 MappedShader_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float MappedShader_transmission_scatter_anisotropy = 0.000000;
uniform float MappedShader_transmission_dispersion = 0.000000;
uniform float MappedShader_transmission_extra_roughness = 0.000000;
uniform float MappedShader_subsurface = 0.000000;
uniform vec3 MappedShader_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 MappedShader_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float MappedShader_subsurface_scale = 1.000000;
uniform float MappedShader_subsurface_anisotropy = 0.000000;
uniform float MappedShader_sheen = 0.000000;
uniform vec3 MappedShader_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float MappedShader_sheen_roughness = 0.300000;
uniform float MappedShader_coat = 1.000000;
uniform vec3 MappedShader_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float MappedShader_coat_roughness = 0.100000;
uniform float MappedShader_coat_anisotropy = 0.000000;
uniform float MappedShader_coat_rotation = 0.000000;
uniform float MappedShader_coat_IOR = 1.500000;
uniform float MappedShader_coat_affect_color = 0.000000;
uniform float MappedShader_coat_affect_roughness = 0.000000;
uniform float MappedShader_thin_film_thickness = 0.000000;
uniform float MappedShader_thin_film_IOR = 1.500000;
uniform float MappedShader_emission = 0.000000;
uniform vec3 MappedShader_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 MappedShader_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool MappedShader_thin_walled = false;
...
void NG_ramp4_color3(vec3 valuetl, vec3 valuetr, vec3 valuebl, vec3 valuebr, vec2 texcoord1, out vec3 out1)
{
    const vec2 N_txclamp_color3_low_tmp = vec2(0.000000, 0.000000);
    const vec2 N_txclamp_color3_high_tmp = vec2(1.000000, 1.000000);
    vec2 N_txclamp_color3_out = clamp(texcoord1, N_txclamp_color3_low_tmp, N_txclamp_color3_high_tmp);
    const int N_s_color3_index_tmp = 0;
    float N_s_color3_out = N_txclamp_color3_out[N_s_color3_index_tmp];
    const int N_t_color3_index_tmp = 1;
    float N_t_color3_out = N_txclamp_color3_out[N_t_color3_index_tmp];
    vec3 N_mixtop_color3_out = mix(valuetl, valuetr, N_s_color3_out);
    vec3 N_mixbot_color3_out = mix(valuebl, valuebr, N_s_color3_out);
    vec3 N_mix_color3_out = mix(N_mixtop_color3_out, N_mixbot_color3_out, N_t_color3_out);
...
void main()
{
    ...
    vec3 ramp4_out = vec3(0.0);
    NG_ramp4_color3(ramp4_valuetl, ramp4_valuetr, ramp4_valuebl, ramp4_valuebr, geomprop_UV0_out1, ramp4_out);
    surfaceshader MappedShader_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(MappedShader_base, ramp4_out, MappedShader_diffuse_roughness, MappedShader_metalness, MappedShader_specular, ramp4_out, MappedShader_specular_roughness, MappedShader_specular_IOR, MappedShader_specular_anisotropy, MappedShader_specular_rotation, MappedShader_transmission, MappedShader_transmission_color, MappedShader_transmission_depth, MappedShader_transmission_scatter, MappedShader_transmission_scatter_anisotropy, MappedShader_transmission_dispersion, MappedShader_transmission_extra_roughness, MappedShader_subsurface, MappedShader_subsurface_color, MappedShader_subsurface_radius, MappedShader_subsurface_scale, MappedShader_subsurface_anisotropy, MappedShader_sheen, MappedShader_sheen_color, MappedShader_sheen_roughness, MappedShader_coat, MappedShader_coat_color, MappedShader_coat_roughness, MappedShader_coat_anisotropy, MappedShader_coat_rotation, MappedShader_coat_IOR, geomprop_Nworld_out1, MappedShader_coat_affect_color, MappedShader_coat_affect_roughness, MappedShader_thin_film_thickness, MappedShader_thin_film_IOR, MappedShader_emission, MappedShader_emission_color, MappedShader_opacity, MappedShader_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, MappedShader_out);
    material MappedShaderMaterial_out = MappedShader_out;
    out1 = vec4(MappedShaderMaterial_out.color, 1.0);
}
