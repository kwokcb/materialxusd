...
uniform float NormalMapShader_base = 1.000000;
uniform vec3 NormalMapShader_base_color = vec3(0.200000, 0.500000, 0.900000);
uniform float NormalMapShader_diffuse_roughness = 0.000000;
uniform float NormalMapShader_metalness = 0.000000;
uniform float NormalMapShader_specular = 1.000000;
uniform vec3 NormalMapShader_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMapShader_specular_roughness = 0.200000;
uniform float NormalMapShader_specular_IOR = 1.500000;
uniform float NormalMapShader_specular_anisotropy = 0.000000;
uniform float NormalMapShader_specular_rotation = 0.000000;
uniform float NormalMapShader_transmission = 0.000000;
uniform vec3 NormalMapShader_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMapShader_transmission_depth = 0.000000;
uniform vec3 NormalMapShader_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float NormalMapShader_transmission_scatter_anisotropy = 0.000000;
uniform float NormalMapShader_transmission_dispersion = 0.000000;
uniform float NormalMapShader_transmission_extra_roughness = 0.000000;
uniform float NormalMapShader_subsurface = 0.000000;
uniform vec3 NormalMapShader_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 NormalMapShader_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMapShader_subsurface_scale = 1.000000;
uniform float NormalMapShader_subsurface_anisotropy = 0.000000;
uniform float NormalMapShader_sheen = 0.000000;
uniform vec3 NormalMapShader_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMapShader_sheen_roughness = 0.300000;
uniform float NormalMapShader_coat = 0.000000;
uniform vec3 NormalMapShader_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMapShader_coat_roughness = 0.100000;
uniform float NormalMapShader_coat_anisotropy = 0.000000;
uniform float NormalMapShader_coat_rotation = 0.000000;
uniform float NormalMapShader_coat_IOR = 1.500000;
uniform float NormalMapShader_coat_affect_color = 0.000000;
uniform float NormalMapShader_coat_affect_roughness = 0.000000;
uniform float NormalMapShader_thin_film_thickness = 0.000000;
uniform float NormalMapShader_thin_film_IOR = 1.500000;
uniform float NormalMapShader_emission = 0.000000;
uniform vec3 NormalMapShader_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 NormalMapShader_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool NormalMapShader_thin_walled = false;
...
void main()
{
    ...
    NG_tiledimage_vector3(tiledimage_file, tiledimage_default, geomprop_UV0_out1, tiledimage_uvtiling, tiledimage_uvoffset, tiledimage_realworldimagesize, tiledimage_realworldtilesize, tiledimage_filtertype, tiledimage_framerange, tiledimage_frameoffset, tiledimage_frameendaction, tiledimage_out);
    ...
    surfaceshader NormalMapShader_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material NormalMapMaterial_out = NormalMapShader_out;
    out1 = vec4(NormalMapMaterial_out.color, 1.0);
}
