...
uniform vec2 tiledimage_realworldtilesize_unit_in1 = vec2(100.000000, 50.000000);
uniform float tiledimage_realworldtilesize_unit_in2 = 0.010000;
uniform vec3 ramp4_valuetl = vec3(1.000000, 1.000000, 0.000000);
uniform vec3 ramp4_valuetr = vec3(0.000000, 0.000000, 0.000000);
uniform vec3 ramp4_valuebl = vec3(1.000000, 1.000000, 0.000000);
uniform vec3 ramp4_valuebr = vec3(1.000000, 1.000000, 1.000000);
uniform sampler2D tiledimage_file;
uniform float tiledimage_default = 0.000000;
uniform vec2 tiledimage_uvtiling = vec2(2.000000, 3.000000);
uniform vec2 tiledimage_uvoffset = vec2(0.200000, 0.200000);
...
uniform float UnitMappedShader_diffuse_roughness = 0.000000;
uniform float UnitMappedShader_metalness = 0.100000;
uniform float UnitMappedShader_specular = 1.000000;
uniform float UnitMappedShader_specular_roughness = 0.200000;
uniform float UnitMappedShader_specular_IOR = 1.500000;
uniform float UnitMappedShader_specular_anisotropy = 0.000000;
uniform float UnitMappedShader_specular_rotation = 0.000000;
uniform float UnitMappedShader_transmission = 0.000000;
uniform vec3 UnitMappedShader_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float UnitMappedShader_transmission_depth = 0.000000;
uniform vec3 UnitMappedShader_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float UnitMappedShader_transmission_scatter_anisotropy = 0.000000;
uniform float UnitMappedShader_transmission_dispersion = 0.000000;
uniform float UnitMappedShader_transmission_extra_roughness = 0.000000;
uniform float UnitMappedShader_subsurface = 0.000000;
uniform vec3 UnitMappedShader_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 UnitMappedShader_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float UnitMappedShader_subsurface_scale = 1.000000;
uniform float UnitMappedShader_subsurface_anisotropy = 0.000000;
uniform float UnitMappedShader_sheen = 0.000000;
uniform vec3 UnitMappedShader_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float UnitMappedShader_sheen_roughness = 0.300000;
uniform float UnitMappedShader_coat = 0.000000;
uniform vec3 UnitMappedShader_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float UnitMappedShader_coat_roughness = 0.100000;
uniform float UnitMappedShader_coat_anisotropy = 0.000000;
uniform float UnitMappedShader_coat_rotation = 0.000000;
uniform float UnitMappedShader_coat_IOR = 1.500000;
uniform float UnitMappedShader_coat_affect_color = 0.000000;
uniform float UnitMappedShader_coat_affect_roughness = 0.000000;
uniform float UnitMappedShader_thin_film_thickness = 0.000000;
uniform float UnitMappedShader_thin_film_IOR = 1.500000;
uniform float UnitMappedShader_emission = 0.000000;
uniform vec3 UnitMappedShader_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 UnitMappedShader_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool UnitMappedShader_thin_walled = false;
...
void main()
{
    ...
    vec2 tiledimage_realworldtilesize_unit_out = tiledimage_realworldtilesize_unit_in1 * tiledimage_realworldtilesize_unit_in2;
    ...
    NG_tiledimage_float(tiledimage_file, tiledimage_default, geomprop_UV0_out1, tiledimage_uvtiling, tiledimage_uvoffset, tiledimage_realworldimagesize, tiledimage_realworldtilesize_unit_out, tiledimage_filtertype, tiledimage_framerange, tiledimage_frameoffset, tiledimage_frameendaction, tiledimage_out);
    surfaceshader UnitMappedShader_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material UnitMappedShaderMaterial_out = UnitMappedShader_out;
    out1 = vec4(UnitMappedShaderMaterial_out.color, 1.0);
}
