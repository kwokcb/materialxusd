...
uniform sampler2D N_surfaceshader_base_color_filename;
...
void NG_network_surface(sampler2D base_color_filename, out surfaceshader out1)
{
    ...
    NG_tiledimage_color3(base_color_filename, vec3(0.000000, 0.000000, 0.000000), geomprop_UV0_out1, vec2(1.000000, 1.000000), vec2(0.000000, 0.000000), vec2(1.000000, 1.000000), vec2(1.000000, 1.000000), 1, 0, 0, 0, base_color_image_out);
    vec3 base_color_image_out_cm_out = vec3(0.0);
    ...
    NG_standard_surface_surfaceshader_100(1.000000, base_color_image_out_cm_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), 0.200000, 1.500000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, geomprop_Nworld_out1, geomprop_Tworld_out1, standard_surface_out);
    out1 = standard_surface_out;
}

void main()
{
    surfaceshader N_surfaceshader_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_network_surface(N_surfaceshader_base_color_filename, N_surfaceshader_out);
    material N_surfacematerial_out = N_surfaceshader_out;
    out1 = vec4(N_surfacematerial_out.color, 1.0);
}
