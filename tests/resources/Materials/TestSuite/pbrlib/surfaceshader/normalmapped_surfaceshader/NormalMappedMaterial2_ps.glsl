...
uniform vec2 tiledimage2_realworldimagesize_unit_in1 = vec2(1.000000, 2.000000);
uniform float tiledimage2_realworldimagesize_unit_in2 = 0.010000;
uniform vec2 tiledimage2_realworldtilesize_unit_in1 = vec2(3.000000, 2.000000);
uniform float tiledimage2_realworldtilesize_unit_in2 = 0.010000;
uniform sampler2D tiledimage2_file;
uniform vec3 tiledimage2_default = vec3(0.000000, 0.000000, 0.000000);
uniform vec2 tiledimage2_uvtiling = vec2(12.000000, 10.000000);
uniform vec2 tiledimage2_uvoffset = vec2(0.000000, 0.000000);
uniform int tiledimage2_filtertype = 1;
uniform int tiledimage2_framerange = 0;
uniform int tiledimage2_frameoffset = 0;
uniform int tiledimage2_frameendaction = 0;
uniform vec2 normalmap_vector2_scale = vec2(1.100000, 1.100000);
uniform float NormalMappedShader2_base = 0.600000;
uniform vec3 NormalMappedShader2_base_color = vec3(0.800000, 0.800000, 0.800000);
uniform float NormalMappedShader2_diffuse_roughness = 0.000000;
uniform float NormalMappedShader2_metalness = 1.000000;
uniform float NormalMappedShader2_specular = 0.700000;
uniform vec3 NormalMappedShader2_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader2_specular_roughness = 0.200000;
uniform float NormalMappedShader2_specular_IOR = 1.500000;
uniform float NormalMappedShader2_specular_anisotropy = 0.000000;
uniform float NormalMappedShader2_specular_rotation = 0.000000;
uniform float NormalMappedShader2_transmission = 0.000000;
uniform vec3 NormalMappedShader2_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader2_transmission_depth = 0.000000;
uniform vec3 NormalMappedShader2_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float NormalMappedShader2_transmission_scatter_anisotropy = 0.000000;
uniform float NormalMappedShader2_transmission_dispersion = 0.000000;
uniform float NormalMappedShader2_transmission_extra_roughness = 0.000000;
uniform float NormalMappedShader2_subsurface = 0.000000;
uniform vec3 NormalMappedShader2_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 NormalMappedShader2_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader2_subsurface_scale = 1.000000;
uniform float NormalMappedShader2_subsurface_anisotropy = 0.000000;
uniform float NormalMappedShader2_sheen = 0.000000;
uniform vec3 NormalMappedShader2_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader2_sheen_roughness = 0.300000;
uniform float NormalMappedShader2_coat = 1.000000;
uniform vec3 NormalMappedShader2_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader2_coat_roughness = 0.100000;
uniform float NormalMappedShader2_coat_anisotropy = 0.000000;
uniform float NormalMappedShader2_coat_rotation = 0.000000;
uniform float NormalMappedShader2_coat_IOR = 1.500000;
uniform float NormalMappedShader2_coat_affect_color = 0.000000;
uniform float NormalMappedShader2_coat_affect_roughness = 0.000000;
uniform float NormalMappedShader2_thin_film_thickness = 0.000000;
uniform float NormalMappedShader2_thin_film_IOR = 1.500000;
uniform float NormalMappedShader2_emission = 0.000000;
uniform vec3 NormalMappedShader2_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 NormalMappedShader2_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool NormalMappedShader2_thin_walled = false;
...
void main()
{
    ...
    vec2 tiledimage2_realworldimagesize_unit_out = tiledimage2_realworldimagesize_unit_in1 * tiledimage2_realworldimagesize_unit_in2;
    vec2 tiledimage2_realworldtilesize_unit_out = tiledimage2_realworldtilesize_unit_in1 * tiledimage2_realworldtilesize_unit_in2;
    vec3 tiledimage2_out = vec3(0.0);
    NG_tiledimage_vector3(tiledimage2_file, tiledimage2_default, geomprop_UV0_out1, tiledimage2_uvtiling, tiledimage2_uvoffset, tiledimage2_realworldimagesize_unit_out, tiledimage2_realworldtilesize_unit_out, tiledimage2_filtertype, tiledimage2_framerange, tiledimage2_frameoffset, tiledimage2_frameendaction, tiledimage2_out);
    vec3 normalmap_vector2_out = vec3(0.0);
    ...
    surfaceshader NormalMappedShader2_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material NormalMappedMaterial2_out = NormalMappedShader2_out;
    out1 = vec4(NormalMappedMaterial2_out.color, 1.0);
}
