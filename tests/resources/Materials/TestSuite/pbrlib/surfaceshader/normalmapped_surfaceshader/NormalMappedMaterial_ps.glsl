...
uniform vec2 tiledimage_realworldimagesize_unit_in1 = vec2(1.000000, 2.000000);
uniform float tiledimage_realworldimagesize_unit_in2 = 0.010000;
uniform vec2 tiledimage_realworldtilesize_unit_in1 = vec2(3.000000, 2.000000);
uniform float tiledimage_realworldtilesize_unit_in2 = 0.010000;
uniform sampler2D tiledimage_file;
uniform vec3 tiledimage_default = vec3(0.000000, 0.000000, 0.000000);
uniform vec2 tiledimage_uvtiling = vec2(12.000000, 10.000000);
...
uniform float normalmap_scale = 1.100000;
uniform float NormalMappedShader_base = 0.600000;
uniform vec3 NormalMappedShader_base_color = vec3(0.800000, 0.800000, 0.800000);
uniform float NormalMappedShader_diffuse_roughness = 0.000000;
uniform float NormalMappedShader_metalness = 1.000000;
uniform float NormalMappedShader_specular = 0.700000;
uniform vec3 NormalMappedShader_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader_specular_roughness = 0.200000;
uniform float NormalMappedShader_specular_IOR = 1.500000;
uniform float NormalMappedShader_specular_anisotropy = 0.000000;
uniform float NormalMappedShader_specular_rotation = 0.000000;
uniform float NormalMappedShader_transmission = 0.000000;
uniform vec3 NormalMappedShader_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader_transmission_depth = 0.000000;
uniform vec3 NormalMappedShader_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float NormalMappedShader_transmission_scatter_anisotropy = 0.000000;
uniform float NormalMappedShader_transmission_dispersion = 0.000000;
uniform float NormalMappedShader_transmission_extra_roughness = 0.000000;
uniform float NormalMappedShader_subsurface = 0.000000;
uniform vec3 NormalMappedShader_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 NormalMappedShader_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader_subsurface_scale = 1.000000;
uniform float NormalMappedShader_subsurface_anisotropy = 0.000000;
uniform float NormalMappedShader_sheen = 0.000000;
uniform vec3 NormalMappedShader_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader_sheen_roughness = 0.300000;
uniform float NormalMappedShader_coat = 1.000000;
uniform vec3 NormalMappedShader_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float NormalMappedShader_coat_roughness = 0.100000;
uniform float NormalMappedShader_coat_anisotropy = 0.000000;
uniform float NormalMappedShader_coat_rotation = 0.000000;
uniform float NormalMappedShader_coat_IOR = 1.500000;
uniform float NormalMappedShader_coat_affect_color = 0.000000;
uniform float NormalMappedShader_coat_affect_roughness = 0.000000;
uniform float NormalMappedShader_thin_film_thickness = 0.000000;
uniform float NormalMappedShader_thin_film_IOR = 1.500000;
uniform float NormalMappedShader_emission = 0.000000;
uniform vec3 NormalMappedShader_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 NormalMappedShader_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool NormalMappedShader_thin_walled = false;
...
void main()
{
    ...
    vec2 tiledimage_realworldimagesize_unit_out = tiledimage_realworldimagesize_unit_in1 * tiledimage_realworldimagesize_unit_in2;
    vec2 tiledimage_realworldtilesize_unit_out = tiledimage_realworldtilesize_unit_in1 * tiledimage_realworldtilesize_unit_in2;
    vec3 tiledimage_out = vec3(0.0);
    NG_tiledimage_vector3(tiledimage_file, tiledimage_default, geomprop_UV0_out1, tiledimage_uvtiling, tiledimage_uvoffset, tiledimage_realworldimagesize_unit_out, tiledimage_realworldtilesize_unit_out, tiledimage_filtertype, tiledimage_framerange, tiledimage_frameoffset, tiledimage_frameendaction, tiledimage_out);
    ...
    surfaceshader NormalMappedShader_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material NormalMappedMaterial_out = NormalMappedShader_out;
    out1 = vec4(NormalMappedMaterial_out.color, 1.0);
}
