...
uniform vec2 checker1_scale = vec2(10.000000, 10.000000);
uniform float standard_surface2_base = 1.000000;
uniform vec3 standard_surface2_base_color = vec3(0.100000, 0.100000, 0.850000);
uniform float standard_surface2_diffuse_roughness = 0.000000;
uniform float standard_surface2_metalness = 0.000000;
uniform float standard_surface2_specular = 1.000000;
uniform vec3 standard_surface2_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface2_specular_roughness = 0.200000;
uniform float standard_surface2_specular_IOR = 1.500000;
uniform float standard_surface2_specular_anisotropy = 0.000000;
uniform float standard_surface2_specular_rotation = 0.000000;
uniform float standard_surface2_transmission = 0.000000;
uniform vec3 standard_surface2_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface2_transmission_depth = 0.000000;
uniform vec3 standard_surface2_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float standard_surface2_transmission_scatter_anisotropy = 0.000000;
uniform float standard_surface2_transmission_dispersion = 0.000000;
uniform float standard_surface2_transmission_extra_roughness = 0.000000;
uniform float standard_surface2_subsurface = 0.000000;
uniform vec3 standard_surface2_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 standard_surface2_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface2_subsurface_scale = 1.000000;
uniform float standard_surface2_subsurface_anisotropy = 0.000000;
uniform float standard_surface2_sheen = 0.000000;
uniform vec3 standard_surface2_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface2_sheen_roughness = 0.300000;
uniform float standard_surface2_coat = 0.000000;
uniform vec3 standard_surface2_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface2_coat_roughness = 0.100000;
uniform float standard_surface2_coat_anisotropy = 0.000000;
uniform float standard_surface2_coat_rotation = 0.000000;
uniform float standard_surface2_coat_IOR = 1.500000;
uniform float standard_surface2_coat_affect_color = 0.000000;
uniform float standard_surface2_coat_affect_roughness = 0.000000;
uniform float standard_surface2_thin_film_thickness = 0.000000;
uniform float standard_surface2_thin_film_IOR = 1.500000;
uniform float standard_surface2_emission = 1.000000;
uniform vec3 standard_surface2_emission_color = vec3(0.000000, 0.000000, 0.000000);
uniform vec3 standard_surface2_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool standard_surface2_thin_walled = false;
uniform vec3 checker3_fg = vec3(1.000000, 0.000000, 0.000000);
uniform vec3 checker3_bg = vec3(0.000000, 0.000000, 0.000000);
uniform float standard_surface1_base = 1.000000;
uniform vec3 standard_surface1_base_color = vec3(0.850000, 0.100000, 0.100000);
...
void NG_checker_float(vec2 scale, out float out1)
{
    vec2 texcoord1_out = vd.texcoord_0.xy;
    vec2 mult1_out = texcoord1_out * scale;
    const int mult1_x_index_tmp = 0;
    float mult1_x_out = mult1_out[mult1_x_index_tmp];
    const int mult1_y_index_tmp = 1;
    float mult1_y_out = mult1_out[mult1_y_index_tmp];
    float floor1_out = floor(mult1_x_out);
    float floor2_out = floor(mult1_y_out);
    float add1_out = floor1_out + floor2_out;
    const float mod1_in2_tmp = 2.000000;
    float mod1_out = mx_mod(add1_out, mod1_in2_tmp);
    out1 = mod1_out;
}
...
void main()
{
    ...
    surfaceshader mix_surface_shader_out = surfaceshader(vec3(0.0),vec3(0.0));
    mx_mix_surfaceshader(standard_surface1_out, standard_surface2_out, mix_surface_shader_mix, mix_surface_shader_out);
    material material_out = mix_surface_shader_out;
