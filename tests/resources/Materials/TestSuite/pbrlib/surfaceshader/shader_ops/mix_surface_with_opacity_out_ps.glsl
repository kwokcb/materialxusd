...
uniform vec2 checker1_scale = vec2(6.000000, 6.000000);
...
uniform float standard_surface2_emission = 0.000000;
uniform vec3 standard_surface2_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 standard_surface2_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool standard_surface2_thin_walled = false;
uniform vec3 checker3_fg = vec3(0.000000, 0.000000, 0.000000);
uniform vec3 checker3_bg = vec3(1.000000, 1.000000, 1.000000);
...
uniform float mix_surface_shader_mix = 0.700000;
