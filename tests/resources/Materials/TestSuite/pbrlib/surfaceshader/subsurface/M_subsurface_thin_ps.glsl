...
uniform float SR_subsurface_base = 1.000000;
uniform vec3 SR_subsurface_base_color = vec3(0.800000, 0.800000, 0.800000);
uniform float SR_subsurface_diffuse_roughness = 0.000000;
uniform float SR_subsurface_metalness = 0.000000;
uniform float SR_subsurface_specular = 0.000000;
uniform vec3 SR_subsurface_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_subsurface_specular_roughness = 0.200000;
uniform float SR_subsurface_specular_IOR = 1.500000;
uniform float SR_subsurface_specular_anisotropy = 0.000000;
uniform float SR_subsurface_specular_rotation = 0.000000;
uniform float SR_subsurface_transmission = 0.000000;
uniform vec3 SR_subsurface_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_subsurface_transmission_depth = 0.000000;
uniform vec3 SR_subsurface_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_subsurface_transmission_scatter_anisotropy = 0.000000;
uniform float SR_subsurface_transmission_dispersion = 0.000000;
uniform float SR_subsurface_transmission_extra_roughness = 0.000000;
uniform float SR_subsurface_subsurface = 1.000000;
uniform vec3 SR_subsurface_subsurface_color = vec3(0.816000, 0.140000, 0.124000);
uniform vec3 SR_subsurface_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_subsurface_subsurface_scale = 1.000000;
uniform float SR_subsurface_subsurface_anisotropy = 0.000000;
uniform float SR_subsurface_sheen = 0.000000;
uniform vec3 SR_subsurface_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_subsurface_sheen_roughness = 0.300000;
uniform float SR_subsurface_coat = 0.000000;
uniform vec3 SR_subsurface_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_subsurface_coat_roughness = 0.100000;
uniform float SR_subsurface_coat_anisotropy = 0.000000;
uniform float SR_subsurface_coat_rotation = 0.000000;
uniform float SR_subsurface_coat_IOR = 1.500000;
uniform float SR_subsurface_coat_affect_color = 0.000000;
uniform float SR_subsurface_coat_affect_roughness = 0.000000;
uniform float SR_subsurface_thin_film_thickness = 0.000000;
uniform float SR_subsurface_thin_film_IOR = 1.500000;
uniform float SR_subsurface_emission = 0.000000;
uniform vec3 SR_subsurface_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_subsurface_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_subsurface_thin_walled = true;
...
void main()
{
    ...
    surfaceshader SR_subsurface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(SR_subsurface_base, SR_subsurface_base_color, SR_subsurface_diffuse_roughness, SR_subsurface_metalness, SR_subsurface_specular, SR_subsurface_specular_color, SR_subsurface_specular_roughness, SR_subsurface_specular_IOR, SR_subsurface_specular_anisotropy, SR_subsurface_specular_rotation, SR_subsurface_transmission, SR_subsurface_transmission_color, SR_subsurface_transmission_depth, SR_subsurface_transmission_scatter, SR_subsurface_transmission_scatter_anisotropy, SR_subsurface_transmission_dispersion, SR_subsurface_transmission_extra_roughness, SR_subsurface_subsurface, SR_subsurface_subsurface_color, SR_subsurface_subsurface_radius, SR_subsurface_subsurface_scale, SR_subsurface_subsurface_anisotropy, SR_subsurface_sheen, SR_subsurface_sheen_color, SR_subsurface_sheen_roughness, SR_subsurface_coat, SR_subsurface_coat_color, SR_subsurface_coat_roughness, SR_subsurface_coat_anisotropy, SR_subsurface_coat_rotation, SR_subsurface_coat_IOR, geomprop_Nworld_out1, SR_subsurface_coat_affect_color, SR_subsurface_coat_affect_roughness, SR_subsurface_thin_film_thickness, SR_subsurface_thin_film_IOR, SR_subsurface_emission, SR_subsurface_emission_color, SR_subsurface_opacity, SR_subsurface_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_subsurface_out);
    material M_subsurface_thin_out = SR_subsurface_out;
    out1 = vec4(M_subsurface_thin_out.color, 1.0);
}
