...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_conductor_bsdf(closureData, conductor_brdf1_weight, conductor_brdf1_artistic_ior_ior, conductor_brdf1_artistic_ior_extinction, conductor_brdf1_roughness, conductor_brdf1_thinfilm_thickness, conductor_brdf1_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, conductor_brdf1_distribution, conductor_brdf1_out);
    ...
    surfaceshader surface2_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_generalized_schlick_bsdf(closureData, SchlickBRDF_layer_top_weight, SchlickBRDF_layer_top_color0, SchlickBRDF_layer_top_color82, SchlickBRDF_layer_top_color90, SchlickBRDF_layer_top_exponent, roughness_dual1_out, SchlickBRDF_layer_top_thinfilm_thickness, SchlickBRDF_layer_top_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, SchlickBRDF_layer_top_distribution, SchlickBRDF_layer_top_scatter_mode, SchlickBRDF_layer_top_out);
        ...
        // Compute and apply surface opacity
        {
            ...
            surface2_out.transparency = mix(vec3(1.0), surface2_out.transparency, surfaceOpacity);
        }
    }
    ...
    out1 = vec4(mix_surface1_out.color, 1.0);
}
