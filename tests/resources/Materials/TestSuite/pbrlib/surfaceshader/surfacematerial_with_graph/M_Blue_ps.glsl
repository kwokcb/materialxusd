...
uniform float displacement_displacement = 0.000000;
uniform float displacement_scale = 1.000000;
uniform float standard_surface_base = 1.000000;
uniform vec3 standard_surface_base_color = vec3(0.300000, 0.300000, 1.000000);
...
void main()
{
    ...
    displacementshader displacement_out = displacementshader(vec3(0.0),1.0);
    mx_displacement_float(displacement_displacement, displacement_scale, displacement_out);
    ...
    material M_Blue_out = standard_surface_out;
    out1 = vec4(M_Blue_out.color, 1.0);
}
