...
uniform vec3 standard_surface1_base_color = vec3(1.000000, 0.000000, 1.000000);
...
void main()
{
    ...
    material M_Magenta_out = standard_surface1_out;
    out1 = vec4(M_Magenta_out.color, 1.0);
}
