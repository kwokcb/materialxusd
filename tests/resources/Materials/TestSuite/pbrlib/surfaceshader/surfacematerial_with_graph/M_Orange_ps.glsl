...
uniform float SR_Orange_base = 1.000000;
uniform vec3 SR_Orange_base_color = vec3(1.000000, 0.300000, 0.000000);
uniform float SR_Orange_diffuse_roughness = 0.000000;
uniform float SR_Orange_metalness = 0.000000;
uniform float SR_Orange_specular = 1.000000;
uniform vec3 SR_Orange_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_Orange_specular_roughness = 0.200000;
uniform float SR_Orange_specular_IOR = 1.500000;
uniform float SR_Orange_specular_anisotropy = 0.000000;
uniform float SR_Orange_specular_rotation = 0.000000;
uniform float SR_Orange_transmission = 0.000000;
uniform vec3 SR_Orange_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_Orange_transmission_depth = 0.000000;
uniform vec3 SR_Orange_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_Orange_transmission_scatter_anisotropy = 0.000000;
uniform float SR_Orange_transmission_dispersion = 0.000000;
uniform float SR_Orange_transmission_extra_roughness = 0.000000;
uniform float SR_Orange_subsurface = 0.000000;
uniform vec3 SR_Orange_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_Orange_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_Orange_subsurface_scale = 1.000000;
uniform float SR_Orange_subsurface_anisotropy = 0.000000;
uniform float SR_Orange_sheen = 0.000000;
uniform vec3 SR_Orange_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_Orange_sheen_roughness = 0.300000;
uniform float SR_Orange_coat = 0.000000;
uniform vec3 SR_Orange_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_Orange_coat_roughness = 0.100000;
uniform float SR_Orange_coat_anisotropy = 0.000000;
uniform float SR_Orange_coat_rotation = 0.000000;
uniform float SR_Orange_coat_IOR = 1.500000;
uniform float SR_Orange_coat_affect_color = 0.000000;
uniform float SR_Orange_coat_affect_roughness = 0.000000;
uniform float SR_Orange_thin_film_thickness = 0.000000;
uniform float SR_Orange_thin_film_IOR = 1.500000;
uniform float SR_Orange_emission = 0.000000;
uniform vec3 SR_Orange_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_Orange_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_Orange_thin_walled = false;
...
void main()
{
    ...
    surfaceshader SR_Orange_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(SR_Orange_base, SR_Orange_base_color, SR_Orange_diffuse_roughness, SR_Orange_metalness, SR_Orange_specular, SR_Orange_specular_color, SR_Orange_specular_roughness, SR_Orange_specular_IOR, SR_Orange_specular_anisotropy, SR_Orange_specular_rotation, SR_Orange_transmission, SR_Orange_transmission_color, SR_Orange_transmission_depth, SR_Orange_transmission_scatter, SR_Orange_transmission_scatter_anisotropy, SR_Orange_transmission_dispersion, SR_Orange_transmission_extra_roughness, SR_Orange_subsurface, SR_Orange_subsurface_color, SR_Orange_subsurface_radius, SR_Orange_subsurface_scale, SR_Orange_subsurface_anisotropy, SR_Orange_sheen, SR_Orange_sheen_color, SR_Orange_sheen_roughness, SR_Orange_coat, SR_Orange_coat_color, SR_Orange_coat_roughness, SR_Orange_coat_anisotropy, SR_Orange_coat_rotation, SR_Orange_coat_IOR, geomprop_Nworld_out1, SR_Orange_coat_affect_color, SR_Orange_coat_affect_roughness, SR_Orange_thin_film_thickness, SR_Orange_thin_film_IOR, SR_Orange_emission, SR_Orange_emission_color, SR_Orange_opacity, SR_Orange_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_Orange_out);
    material M_Orange_out = SR_Orange_out;
    out1 = vec4(M_Orange_out.color, 1.0);
}
