...
uniform float geometric_opacity_hint_base_weight = 1.000000;
uniform vec3 geometric_opacity_hint_base_color = vec3(0.800000, 0.800000, 0.800000);
uniform float geometric_opacity_hint_base_diffuse_roughness = 0.000000;
uniform float geometric_opacity_hint_base_metalness = 0.000000;
uniform float geometric_opacity_hint_specular_weight = 1.000000;
uniform vec3 geometric_opacity_hint_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float geometric_opacity_hint_specular_roughness = 0.300000;
uniform float geometric_opacity_hint_specular_ior = 1.500000;
uniform float geometric_opacity_hint_specular_roughness_anisotropy = 0.000000;
uniform float geometric_opacity_hint_transmission_weight = 0.000000;
uniform vec3 geometric_opacity_hint_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float geometric_opacity_hint_transmission_depth = 0.000000;
uniform vec3 geometric_opacity_hint_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float geometric_opacity_hint_transmission_scatter_anisotropy = 0.000000;
uniform float geometric_opacity_hint_transmission_dispersion_scale = 0.000000;
uniform float geometric_opacity_hint_transmission_dispersion_abbe_number = 20.000000;
uniform float geometric_opacity_hint_subsurface_weight = 0.000000;
uniform vec3 geometric_opacity_hint_subsurface_color = vec3(0.800000, 0.800000, 0.800000);
uniform float geometric_opacity_hint_subsurface_radius = 1.000000;
uniform vec3 geometric_opacity_hint_subsurface_radius_scale = vec3(1.000000, 0.500000, 0.250000);
uniform float geometric_opacity_hint_subsurface_scatter_anisotropy = 0.000000;
uniform float geometric_opacity_hint_fuzz_weight = 0.000000;
uniform vec3 geometric_opacity_hint_fuzz_color = vec3(1.000000, 1.000000, 1.000000);
uniform float geometric_opacity_hint_fuzz_roughness = 0.500000;
uniform float geometric_opacity_hint_coat_weight = 0.000000;
uniform vec3 geometric_opacity_hint_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float geometric_opacity_hint_coat_roughness = 0.000000;
uniform float geometric_opacity_hint_coat_roughness_anisotropy = 0.000000;
uniform float geometric_opacity_hint_coat_ior = 1.600000;
uniform float geometric_opacity_hint_coat_darkening = 1.000000;
uniform float geometric_opacity_hint_thin_film_weight = 0.000000;
uniform float geometric_opacity_hint_thin_film_thickness = 0.500000;
uniform float geometric_opacity_hint_thin_film_ior = 1.400000;
uniform float geometric_opacity_hint_emission_luminance = 0.000000;
uniform vec3 geometric_opacity_hint_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float geometric_opacity_hint_geometry_opacity = 0.500000;
uniform bool geometric_opacity_hint_geometry_thin_walled = false;
...
void main()
{
    ...
    surfaceshader geometric_opacity_hint_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_open_pbr_surface_surfaceshader(geometric_opacity_hint_base_weight, geometric_opacity_hint_base_color, geometric_opacity_hint_base_diffuse_roughness, geometric_opacity_hint_base_metalness, geometric_opacity_hint_specular_weight, geometric_opacity_hint_specular_color, geometric_opacity_hint_specular_roughness, geometric_opacity_hint_specular_ior, geometric_opacity_hint_specular_roughness_anisotropy, geometric_opacity_hint_transmission_weight, geometric_opacity_hint_transmission_color, geometric_opacity_hint_transmission_depth, geometric_opacity_hint_transmission_scatter, geometric_opacity_hint_transmission_scatter_anisotropy, geometric_opacity_hint_transmission_dispersion_scale, geometric_opacity_hint_transmission_dispersion_abbe_number, geometric_opacity_hint_subsurface_weight, geometric_opacity_hint_subsurface_color, geometric_opacity_hint_subsurface_radius, geometric_opacity_hint_subsurface_radius_scale, geometric_opacity_hint_subsurface_scatter_anisotropy, geometric_opacity_hint_fuzz_weight, geometric_opacity_hint_fuzz_color, geometric_opacity_hint_fuzz_roughness, geometric_opacity_hint_coat_weight, geometric_opacity_hint_coat_color, geometric_opacity_hint_coat_roughness, geometric_opacity_hint_coat_roughness_anisotropy, geometric_opacity_hint_coat_ior, geometric_opacity_hint_coat_darkening, geometric_opacity_hint_thin_film_weight, geometric_opacity_hint_thin_film_thickness, geometric_opacity_hint_thin_film_ior, geometric_opacity_hint_emission_luminance, geometric_opacity_hint_emission_color, geometric_opacity_hint_geometry_opacity, geometric_opacity_hint_geometry_thin_walled, geomprop_Nworld_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, geomprop_Tworld_out1, geometric_opacity_hint_out);
    material geom_hint_out = geometric_opacity_hint_out;
    float outAlpha = clamp(1.0 - dot(geom_hint_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(geom_hint_out.color, outAlpha);
