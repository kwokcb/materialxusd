...
uniform float transparency_weight_hint_base_weight = 1.000000;
uniform vec3 transparency_weight_hint_base_color = vec3(0.800000, 0.800000, 0.800000);
uniform float transparency_weight_hint_base_diffuse_roughness = 0.000000;
uniform float transparency_weight_hint_base_metalness = 0.000000;
uniform float transparency_weight_hint_specular_weight = 1.000000;
uniform vec3 transparency_weight_hint_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float transparency_weight_hint_specular_roughness = 0.300000;
uniform float transparency_weight_hint_specular_ior = 1.500000;
uniform float transparency_weight_hint_specular_roughness_anisotropy = 0.000000;
uniform float transparency_weight_hint_transmission_weight = 0.800000;
uniform vec3 transparency_weight_hint_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float transparency_weight_hint_transmission_depth = 0.000000;
uniform vec3 transparency_weight_hint_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float transparency_weight_hint_transmission_scatter_anisotropy = 0.000000;
uniform float transparency_weight_hint_transmission_dispersion_scale = 0.000000;
uniform float transparency_weight_hint_transmission_dispersion_abbe_number = 20.000000;
uniform float transparency_weight_hint_subsurface_weight = 0.000000;
uniform vec3 transparency_weight_hint_subsurface_color = vec3(0.800000, 0.800000, 0.800000);
uniform float transparency_weight_hint_subsurface_radius = 1.000000;
uniform vec3 transparency_weight_hint_subsurface_radius_scale = vec3(1.000000, 0.500000, 0.250000);
uniform float transparency_weight_hint_subsurface_scatter_anisotropy = 0.000000;
uniform float transparency_weight_hint_fuzz_weight = 0.000000;
uniform vec3 transparency_weight_hint_fuzz_color = vec3(1.000000, 1.000000, 1.000000);
uniform float transparency_weight_hint_fuzz_roughness = 0.500000;
uniform float transparency_weight_hint_coat_weight = 0.000000;
uniform vec3 transparency_weight_hint_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float transparency_weight_hint_coat_roughness = 0.000000;
uniform float transparency_weight_hint_coat_roughness_anisotropy = 0.000000;
uniform float transparency_weight_hint_coat_ior = 1.600000;
uniform float transparency_weight_hint_coat_darkening = 1.000000;
uniform float transparency_weight_hint_thin_film_weight = 0.000000;
uniform float transparency_weight_hint_thin_film_thickness = 0.500000;
uniform float transparency_weight_hint_thin_film_ior = 1.400000;
uniform float transparency_weight_hint_emission_luminance = 0.000000;
uniform vec3 transparency_weight_hint_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float transparency_weight_hint_geometry_opacity = 1.000000;
uniform bool transparency_weight_hint_geometry_thin_walled = false;
...
void main()
{
    ...
    surfaceshader transparency_weight_hint_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_open_pbr_surface_surfaceshader(transparency_weight_hint_base_weight, transparency_weight_hint_base_color, transparency_weight_hint_base_diffuse_roughness, transparency_weight_hint_base_metalness, transparency_weight_hint_specular_weight, transparency_weight_hint_specular_color, transparency_weight_hint_specular_roughness, transparency_weight_hint_specular_ior, transparency_weight_hint_specular_roughness_anisotropy, transparency_weight_hint_transmission_weight, transparency_weight_hint_transmission_color, transparency_weight_hint_transmission_depth, transparency_weight_hint_transmission_scatter, transparency_weight_hint_transmission_scatter_anisotropy, transparency_weight_hint_transmission_dispersion_scale, transparency_weight_hint_transmission_dispersion_abbe_number, transparency_weight_hint_subsurface_weight, transparency_weight_hint_subsurface_color, transparency_weight_hint_subsurface_radius, transparency_weight_hint_subsurface_radius_scale, transparency_weight_hint_subsurface_scatter_anisotropy, transparency_weight_hint_fuzz_weight, transparency_weight_hint_fuzz_color, transparency_weight_hint_fuzz_roughness, transparency_weight_hint_coat_weight, transparency_weight_hint_coat_color, transparency_weight_hint_coat_roughness, transparency_weight_hint_coat_roughness_anisotropy, transparency_weight_hint_coat_ior, transparency_weight_hint_coat_darkening, transparency_weight_hint_thin_film_weight, transparency_weight_hint_thin_film_thickness, transparency_weight_hint_thin_film_ior, transparency_weight_hint_emission_luminance, transparency_weight_hint_emission_color, transparency_weight_hint_geometry_opacity, transparency_weight_hint_geometry_thin_walled, geomprop_Nworld_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, geomprop_Tworld_out1, transparency_weight_hint_out);
    material transp_hint_out = transparency_weight_hint_out;
    float outAlpha = clamp(1.0 - dot(transp_hint_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(transp_hint_out.color, outAlpha);
