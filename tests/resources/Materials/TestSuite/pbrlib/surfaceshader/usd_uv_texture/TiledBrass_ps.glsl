...
uniform sampler2D texture_base_color_file;
uniform int texture_base_color_wrapS = 2;
uniform int texture_base_color_wrapT = 2;
uniform vec4 texture_base_color_fallback = vec4(0.000000, 0.000000, 0.000000, 1.000000);
uniform vec4 texture_base_color_scale = vec4(1.000000, 1.000000, 1.000000, 1.000000);
uniform vec4 texture_base_color_bias = vec4(0.000000, 0.000000, 0.000000, 0.000000);
uniform sampler2D texture_roughness_file;
uniform int texture_roughness_wrapS = 2;
uniform int texture_roughness_wrapT = 2;
uniform vec4 texture_roughness_fallback = vec4(0.000000, 0.000000, 0.000000, 1.000000);
uniform vec4 texture_roughness_scale = vec4(1.000000, 1.000000, 1.000000, 1.000000);
uniform vec4 texture_roughness_bias = vec4(0.000000, 0.000000, 0.000000, 0.000000);
...
uniform float UsdPreviewSurface_metallic = 1.000000;
...
uniform vec3 UsdPreviewSurface_normal = vec3(0.000000, 0.000000, 1.000000);
...
void main()
{
    ...
    vec3 texture_base_color_rgb = vec3(0.0);
    IMP_UsdUVTexture_23(texture_base_color_file, geomprop_UV0_out1, texture_base_color_wrapS, texture_base_color_wrapT, texture_base_color_fallback, texture_base_color_scale, texture_base_color_bias, texture_base_color_r, texture_base_color_g, texture_base_color_b, texture_base_color_a, texture_base_color_rgb);
    float texture_roughness_r = 0.0;
    float texture_roughness_g = 0.0;
    float texture_roughness_b = 0.0;
    float texture_roughness_a = 0.0;
    vec3 texture_roughness_rgb = vec3(0.0);
    IMP_UsdUVTexture_23(texture_roughness_file, geomprop_UV0_out1, texture_roughness_wrapS, texture_roughness_wrapT, texture_roughness_fallback, texture_roughness_scale, texture_roughness_bias, texture_roughness_r, texture_roughness_g, texture_roughness_b, texture_roughness_a, texture_roughness_rgb);
    vec3 texture_base_color_rgb_cm_out = vec3(0.0);
    ...
    material TiledBrass_out = UsdPreviewSurface_out;
    float outAlpha = clamp(1.0 - dot(TiledBrass_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(TiledBrass_out.color, outAlpha);
