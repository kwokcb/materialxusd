...
void main()
{
    ...
    vec3 image_acescg_out1 = vec3(0.0);
    mx_image_color3(image_acescg_file, image_acescg_layer, image_acescg_default, geomprop_UV0_out1, image_acescg_uaddressmode, image_acescg_vaddressmode, image_acescg_filtertype, image_acescg_framerange, image_acescg_frameoffset, image_acescg_frameendaction, image_acescg_uv_scale, image_acescg_uv_offset, image_acescg_out1);
    vec3 image_acescg_out_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(image_acescg_out1, image_acescg_out_cm_out);
    ...
    image_acescg_out = vec4(image_acescg_standard_surface5_out.color, 1.0);
}
