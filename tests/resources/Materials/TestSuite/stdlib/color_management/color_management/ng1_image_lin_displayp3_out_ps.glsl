...
out vec4 image_lin_displayp3_out;
...
void main()
{
    ...
    vec3 image_lin_displayp3_out1 = vec3(0.0);
    mx_image_color3(image_lin_displayp3_file, image_lin_displayp3_layer, image_lin_displayp3_default, geomprop_UV0_out1, image_lin_displayp3_uaddressmode, image_lin_displayp3_vaddressmode, image_lin_displayp3_filtertype, image_lin_displayp3_framerange, image_lin_displayp3_frameoffset, image_lin_displayp3_frameendaction, image_lin_displayp3_uv_scale, image_lin_displayp3_uv_offset, image_lin_displayp3_out1);
    vec3 image_lin_displayp3_out_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(image_lin_displayp3_out1, image_lin_displayp3_out_cm_out);
    ...
    image_lin_displayp3_out = vec4(image_lin_displayp3_standard_surface10_out.color, 1.0);
}
