...
out vec4 image_srgb_texture_out;
...
void main()
{
    ...
    vec3 image_srgb_texture_out1 = vec3(0.0);
    mx_image_color3(image_srgb_texture_file, image_srgb_texture_layer, image_srgb_texture_default, geomprop_UV0_out1, image_srgb_texture_uaddressmode, image_srgb_texture_vaddressmode, image_srgb_texture_filtertype, image_srgb_texture_framerange, image_srgb_texture_frameoffset, image_srgb_texture_frameendaction, image_srgb_texture_uv_scale, image_srgb_texture_uv_offset, image_srgb_texture_out1);
    vec3 image_srgb_texture_out_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(image_srgb_texture_out1, image_srgb_texture_out_cm_out);
    ...
    image_srgb_texture_out = vec4(image_srgb_texture_standard_surface6_out.color, 1.0);
}
