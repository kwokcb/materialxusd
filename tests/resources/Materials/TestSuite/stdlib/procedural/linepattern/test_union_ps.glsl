...
void NG_grid_color3(vec2 texcoord1, vec2 uvtiling, vec2 uvoffset, float thickness, bool staggered, out vec3 out1)
{
...
void NG_line_float(vec2 texcoord1, vec2 center, float radius, vec2 point1, vec2 point2, out float out1)
{
...
void NG_crosshatch_color3(vec2 texcoord1, vec2 uvtiling, vec2 uvoffset, float thickness, bool staggered, out vec3 out1)
{
    vec2 texcoord_scale_out = texcoord1 * uvtiling;
    vec2 texcoord_bias_out = texcoord_scale_out - uvoffset;
    float texcoord_bias_separate_outx = 0.0;
