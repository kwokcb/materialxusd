...
void NG_circle_float(vec2 texcoord1, vec2 center, float radius, out float out1)
{
    vec2 delta_out = texcoord1 - center;
...
void NG_cloverleaf_float(vec2 texcoord1, vec2 center, float radius, out float out1)
{
    vec2 sample_double_out = texcoord1 + texcoord1;
    ...
    NG_circle_float(coord1_out, center, radius, circle1_out);
    float circle4_out = 0.0;
    NG_circle_float(coord4_out, center, radius, circle4_out);
    float circle2_out = 0.0;
    NG_circle_float(coord2_out, center, radius, circle2_out);
    float circle3_out = 0.0;
    NG_circle_float(coord3_out, center, radius, circle3_out);
...
void NG_tiledcloverleafs_color3(vec2 texcoord1, vec2 uvtiling, vec2 uvoffset, float size, bool staggered, out vec3 out1)
{
    vec2 texcoord_scale_out = texcoord1 * uvtiling;
