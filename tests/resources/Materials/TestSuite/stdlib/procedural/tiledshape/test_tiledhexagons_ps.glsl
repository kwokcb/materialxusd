...
void NG_hexagon_float(vec2 texcoord1, vec2 center, float radius, out float out1)
{
...
void NG_tiledhexagons_color3(vec2 texcoord1, vec2 uvtiling, vec2 uvoffset, float size, bool staggered, out vec3 out1)
{
